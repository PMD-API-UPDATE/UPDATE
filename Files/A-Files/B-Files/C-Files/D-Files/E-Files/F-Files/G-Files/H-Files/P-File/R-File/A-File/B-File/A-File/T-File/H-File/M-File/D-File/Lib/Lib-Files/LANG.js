const LANG = {
  en: {
    findtiktokq: "❌ *Please Give Me A Title*",
    ...
    boomq: "❌ *Please Give Me A Text or Media message!!*",
...
data: {
  ...
  si: {
    findtiktokq: "❌ *කරුණාකර මට වචනයක් දෙන්න!*",
    ...
    boomq: "❌ *කරුණාකර මට Text එකක් හෝ media message එකක් ලබාදෙන්න*",
